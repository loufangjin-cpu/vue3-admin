	...
	<div class="tabs-content">
		<div class="tabs-scroll">
			<el-tabs v-model="activeMenu" type="card" @tab-click="handleTag" @tab-remove="handleClose">
				<el-tab-pane v-for="(item, index) in tabs" :key="index" :closable="!item.unCloseable" :name="item.id" :label="item.name">
					{{ item.name }}
				</el-tab-pane>
			</el-tabs>
		</div>
		<el-dropdown trigger="click">
			...
			<template #dropdown>
				<el-dropdown-menu class="tabs-menu">
					<el-dropdown-item :disabled="disabledCurrent" icon="el-icon-close" @click="handleMenuClose('current')"> 关闭当前标签页 </el-dropdown-item>
					<el-divider></el-divider>
					<el-dropdown-item :disabled="disabledLeft" icon="el-icon-download left" @click="handleMenuClose('left')"> 关闭左侧标签页 </el-dropdown-item>
					<el-dropdown-item :disabled="disabledRight" icon="el-icon-download right" @click="handleMenuClose('right')">
						关闭右侧标签页
					</el-dropdown-item>
					<el-divider></el-divider>
					<el-dropdown-item :disabled="disabledOther" icon="el-icon-document-remove" @click="handleMenuClose('other')">
						关闭其他标签页
					</el-dropdown-item>
					<el-dropdown-item :disabled="disabledAll" icon="el-icon-document-delete" @click="handleMenuClose('all')"> 关闭所有标签页 </el-dropdown-item>
				</el-dropdown-menu>
			</template>
		</el-dropdown>
	</div>
