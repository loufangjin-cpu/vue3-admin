...
export const _data = {
	...
	navbarThemeList: ['#FFFFFF', '#151515', '#009688', '#5172DC', '#409EFF', '#E74C3C', '#24292E', '#394664', '#001529', '#383F45'],
	sidebarThemeColor: '#001529',
	sidebarThemeList: ['#001529', '#212121', '#273352', '#FFFFFF', '#191B24', '#191A23', '#304156', '#28333E', '#344058', '#383F45'],
	showBreadcrumb: true,
	showTabs: true,
};
