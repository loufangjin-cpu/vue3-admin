<template>
	<el-drawer v-model="drawer" title="项目配置" :show-close="true">
		<div class="draw-content">
			<el-divider>主题</el-divider>
			<div class="flex-justify-center day-mode">
				<el-switch v-model="nightMode" active-text="夜间模式" inactive-text="日间模式" @change="changeSetting('nightMode', nightMode)"></el-switch>
			</div>
			<el-divider>导航栏模式</el-divider>
			<div class="nav-row">
				<el-tooltip v-for="(item, index) in navbarList" :key="index" effect="dark" placement="bottom" :content="item" :disabled="!drawer">
					<div :class="['nav-item', `nav-item-${index}`, { active: navbarType === item }]" @click="changeSetting('navbarType', item)"></div>
				</el-tooltip>
			</div>
			...
			<div class="other-row">
				<span>面包屑</span>
				<el-switch v-model="showBreadcrumb" class="custom-switch" @change="changeSetting('showBreadcrumb', $event)"></el-switch>
			</div>
			<div class="other-row">
				<span>导航页</span>
